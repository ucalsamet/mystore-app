...
export default {
  ...
  watch: {
    priceFilter(value) {
      ...
      if (value == 0) {
        ...
        this.getProducts = [];
        for (let key in products) {
          if (products[key].price > 25 && products[key].price <= 100) {
            this.getProducts.push({
              _id: products[key]._id,
              title: products[key].title,
              price: products[key].price,
        ...
        this.getProducts = [];
        for (let key in products) {
          if (products[key].price > 100 && products[key].price <= 500) {
            this.getProducts.push({
              _id: products[key]._id,
              title: products[key].title,
              price: products[key].price,
  ...
  created() {
    this.getProducts = this.$store.getters.getProducts;
  }
};
</script>
